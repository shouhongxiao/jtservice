...
import jtservice.utility.ConfBeanMetaData;
import jtservice.utility.ZkConfig;
import jtservice.utility.ZkValue;
...
public class BeanRegisterCenter {
    private Map<Object, Class<?>> registers = Maps.newConcurrentMap();
    private Map<String,ConfBeanMetaData> elements = Maps.newConcurrentMap();
    private Logger logger =Logger.getLogger(BeanRegisterCenter.class);

    public Map<String,ConfBeanMetaData> getElements()
    {
        return ImmutableMap.copyOf(elements);
    }

    public Map<Object, Class<?>> getRegisters()
    {
        return ImmutableMap.copyOf(registers);
    }
    ...
    public boolean hasZkConfigAnnotationed(){
        ...
        Set<Map.Entry<Object, Class<?>>> entrySet = registers.entrySet();
        for(Map.Entry<Object, Class<?>> entry : entrySet){
